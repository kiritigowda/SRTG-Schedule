...
RTGS_DEBUG_MSG=0 ./bin/SRTG-Scheduler --j bin/testData/aperiodic-set-0-syntheticJobs.csv --r bin/testData/aperiodic-set-0-syntheticJobReleaseTimes.csv --m
...
#Job Set 1
RTGS_DEBUG_MSG=2 ./bin/SRTG-Scheduler --j bin/testData/set1-jobs.txt --r bin/testData/set1-jobReleaseTimes.txt --m
RTGS_DEBUG_MSG=2 ./bin/SRTG-Scheduler --j bin/testData/set1-jobs.txt --r bin/testData/set1-jobReleaseTimes.txt --m 1
RTGS_DEBUG_MSG=2 ./bin/SRTG-Scheduler --j bin/testData/set1-jobs.txt --r bin/testData/set1-jobReleaseTimes.txt --m 2
RTGS_DEBUG_MSG=2 ./bin/SRTG-Scheduler --j bin/testData/set1-jobs.txt --r bin/testData/set1-jobReleaseTimes.txt --m 3
RTGS_DEBUG_MSG=2 ./bin/SRTG-Scheduler --j bin/testData/set1-jobs.txt --r bin/testData/set1-jobReleaseTimes.txt --m 4
RTGS_DEBUG_MSG=0 ./bin/SRTG-Scheduler --j bin/testData/set1-jobs.txt --r bin/testData/set1-jobReleaseTimes.txt --m 5
RTGS_DEBUG_MSG=0 ./bin/SRTG-Scheduler --j bin/testData/set1-jobs.txt --r bin/testData/set1-jobReleaseTimes.txt --m 99
#Job Set 2
RTGS_DEBUG_MSG=0 ./bin/SRTG-Scheduler --j bin/testData/set2-jobs.txt --r bin/testData/set2-jobReleaseTimes.txt --m 99
RTGS_DEBUG_MSG=1 ./bin/SRTG-Scheduler --j bin/testData/set2-jobs.txt --r bin/testData/set3-jobReleaseTimes.txt --m 99
RTGS_DEBUG_MSG=2 ./bin/SRTG-Scheduler --j bin/testData/set2-jobs.txt --r bin/testData/set4-jobReleaseTimes.txt --m 99
RTGS_DEBUG_MSG=3 ./bin/SRTG-Scheduler --j bin/testData/set2-jobs.txt --r bin/testData/set5-jobReleaseTimes.txt --m 99
RTGS_DEBUG_MSG=3 ./bin/SRTG-Scheduler --j bin/testData/set2-jobs.txt --r bin/testData/set6-jobReleaseTimes.txt --m 99
RTGS_DEBUG_MSG=3 ./bin/SRTG-Scheduler --j bin/testData/set2-jobs.txt --r bin/testData/set7-jobReleaseTimes.txt --m 99
RTGS_DEBUG_MSG=3 ./bin/SRTG-Scheduler --j bin/testData/set2-jobs.txt --r bin/testData/set8-jobReleaseTimes.txt --m 99
RTGS_DEBUG_MSG=3 ./bin/SRTG-Scheduler --j bin/testData/set2-jobs.txt --r bin/testData/set9-jobReleaseTimes.txt --m 99
RTGS_DEBUG_MSG=3 ./bin/SRTG-Scheduler --j bin/testData/set2-jobs.txt --r bin/testData/set10-jobReleaseTimes.txt --m 99
RTGS_DEBUG_MSG=3 ./bin/SRTG-Scheduler --j bin/testData/set2-jobs.txt --r bin/testData/set11-jobReleaseTimes.txt --m 99
#Job Set 3
...
#Job Set 11
RTGS_DEBUG_MSG=0 ./bin/SRTG-Scheduler --j bin/testData/set11-jobs.txt --r bin/testData/set2-jobReleaseTimes.txt --m 99
RTGS_DEBUG_MSG=0 ./bin/SRTG-Scheduler --j bin/testData/set11-jobs.txt --r bin/testData/set3-jobReleaseTimes.txt --m 99
RTGS_DEBUG_MSG=0 ./bin/SRTG-Scheduler --j bin/testData/set11-jobs.txt --r bin/testData/set4-jobReleaseTimes.txt --m 99
RTGS_DEBUG_MSG=0 ./bin/SRTG-Scheduler --j bin/testData/set11-jobs.txt --r bin/testData/set5-jobReleaseTimes.txt --m 99
RTGS_DEBUG_MSG=0 ./bin/SRTG-Scheduler --j bin/testData/set11-jobs.txt --r bin/testData/set6-jobReleaseTimes.txt --m 99
RTGS_DEBUG_MSG=0 ./bin/SRTG-Scheduler --j bin/testData/set11-jobs.txt --r bin/testData/set7-jobReleaseTimes.txt --m 99
RTGS_DEBUG_MSG=0 ./bin/SRTG-Scheduler --j bin/testData/set11-jobs.txt --r bin/testData/set8-jobReleaseTimes.txt --m 99
RTGS_DEBUG_MSG=0 ./bin/SRTG-Scheduler --j bin/testData/set11-jobs.txt --r bin/testData/set9-jobReleaseTimes.txt --m 99
RTGS_DEBUG_MSG=0 ./bin/SRTG-Scheduler --j bin/testData/set11-jobs.txt --r bin/testData/set10-jobReleaseTimes.txt --m 99
RTGS_DEBUG_MSG=0 ./bin/SRTG-Scheduler --j bin/testData/set11-jobs.txt --r bin/testData/set11-jobReleaseTimes.txt --m 99
# Option Test
