...
for x in range(row_count):
    ...
    if(x < row_count-1):
        ...
        print '\t\t\t\t['+str(delayElement)+','+str(data_1[x][6])+','+str(data_2[x][6])+','+str(data_3[x][6])+','+str(data_4[x][6])+','+str(data_5[x][6])+']'
print"\t\t\t]);"
print"\t\t\tvar options = {  title:'Total GPU Usage', hAxis: { title: 'delay Schedule limit percentage'}, vAxis: {title: 'Total GPU Usage'}, series: { 0.01: {curveType: 'function'} }, width:900, height:600 };"
...
for x in range(row_count):
    ...
    if(x < row_count-1):
        ...
        print '\t\t\t\t['+str(delayElement)+','+str(data_1[x][8])+','+str(data_2[x][8])+','+str(data_3[x][8])+','+str(data_4[x][8])+','+str(data_5[x][8])+']'
print"\t\t\t]);"
print"\t\t\tvar options = {  title:'Average Response Time', hAxis: { title: 'delay Schedule limit percentage'}, vAxis: {title: 'Response Time'}, series: { 0.01: {curveType: 'function'} }, width:900, height:600 };"
...
for x in range(row_count):
    delayElement = delayElement + 10;
    if(x < row_count-1):
        print '\t\t\t\t['+str(delayElement)+','+str(data_1[x][9])+','+str(data_2[x][9])+','+str(data_3[x][9])+','+str(data_4[x][9])+','+str(data_5[x][9])+'],'
    else:
        print '\t\t\t\t['+str(delayElement)+','+str(data_1[x][9])+','+str(data_2[x][9])+','+str(data_3[x][9])+','+str(data_4[x][9])+','+str(data_5[x][9])+']'
print"\t\t\t]);"
print"\t\t\tvar options = {  title:'Average Response Factor', hAxis: { title: 'delay Schedule limit percentage'}, vAxis: {title: 'Response Factor'}, series: { 0.01: {curveType: 'function'} }, width:900, height:600 };"
...
for x in range(row_count):
    ...
    if(x < row_count-1):
        ...
        print '\t\t\t\t['+str(delayElement)+','+str(data_1[x][7])+','+str(data_2[x][7])+','+str(data_3[x][7])+','+str(data_4[x][7])+','+str(data_5[x][7])+']'
print"\t\t\t]);"
print"\t\t\tvar options = {  title:'GPU Usage Percentage', hAxis: { title: 'delay Schedule limit percentage'}, vAxis: {title: 'GPU Usage Percentage'}, series: { 0.01: {curveType: 'function'} }, width:900, height:600 };"
...
print"\t</head>"
print"\t<body>"
print'\t\t<br><br><h2><center>Release Time Lambda: 1.0 & Processor:16</center></h2><br>'
