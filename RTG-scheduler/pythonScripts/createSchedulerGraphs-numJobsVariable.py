...
for x in range(row_count):
    ...
    if(x < row_count-1):
        ...
        print '\t\t\t\t['+str(numJobs)+','+str(data_1[x][9])+','+str(data_2[x][9])+','+str(data_3[x][9])+','+str(data_4[x][9])+','+str(data_5[x][9])+']'
print"\t\t\t]);"
print"\t\t\tvar options = {  title:'Average Jobs Scheduled Percentage', hAxis: { title: 'Num Jobs in Test Set'}, vAxis: {title: 'Avg Number of Jobs Scheduled'}, series: { 0.01: {curveType: 'function'} }, width:900, height:600 };"
